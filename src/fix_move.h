...
class FixMove : public Fix {
 ...
 private:
  char *xvarstr, *yvarstr, *zvarstr, *vxvarstr, *vyvarstr, *vzvarstr, *rvarstr,*vrvarstr;
  int mstyle;
  int vxflag, vyflag, vzflag, axflag, ayflag, azflag,vrflag;
  double vx, vy, vz, ax, ay, az,vr;
  double period, omega_rotate;
  double point[3], axis[3], runit[3];
  double dt, dtv, dtf;
  int xvar, yvar, zvar, vxvar, vyvar, vzvar,rvar,vrvar;
  int xvarstyle, yvarstyle, zvarstyle, vxvarstyle, vyvarstyle, vzvarstyle,rvarstyle,vrvarstyle;
  ...
  int rdisplaceflag, rvelocityflag;
  int maxatom;
  double **displace, **velocity, *rdisplace,*rvelocity;
