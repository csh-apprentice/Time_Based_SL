...
PairLJCutDEBUG::PairLJCutDEBUG(LAMMPS *lmp) : Pair(lmp)
{
  respa_enable = 1;
...
void PairLJCutDEBUG::compute(int eflag, int vflag)
{
...
void PairLJCutDEBUG::compute_inner()
{
  int i, j, ii, jj, inum, jnum, itype, jtype;
...
void PairLJCutDEBUG::compute_middle()
{
  int i, j, ii, jj, inum, jnum, itype, jtype;
  double xtmp, ytmp, ztmp, delx, dely, delz, fpair;
  double rsq, r2inv, r6inv, forcelj, factor_lj, rsw;
...
void PairLJCutDEBUG::compute_outer(int eflag, int vflag)
{
  int i, j, ii, jj, inum, jnum, itype, jtype;
  double xtmp, ytmp, ztmp, delx, dely, delz, evdwl, fpair;
  double rsq, r2inv, r6inv, forcelj, factor_lj, rsw;
...
void PairLJCutDEBUG::settings(int narg, char **arg)
{
...
void PairLJCutDEBUG::coeff(int narg, char **arg)
{
...
void PairLJCutDEBUG::init_style()
{
...
double PairLJCutDEBUG::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
...
void PairLJCutDEBUG::write_restart(FILE *fp)
{
...
void PairLJCutDEBUG::read_restart(FILE *fp)
{
...
void PairLJCutDEBUG::write_restart_settings(FILE *fp)
{
...
void PairLJCutDEBUG::read_restart_settings(FILE *fp)
{
  int me = comm->me;
  if (me == 0) {
...
void PairLJCutDEBUG::write_data(FILE *fp)
{
...
void PairLJCutDEBUG::write_data_all(FILE *fp)
{
...
double PairLJCutDEBUG::single(int /*i*/, int /*j*/, int itype, int jtype, double rsq,
...
void PairLJCutDEBUG::born_matrix(int /*i*/, int /*j*/, int itype, int jtype, double rsq,
...
void *PairLJCutDEBUG::extract(const char *str, int &dim)
{
  dim = 2;
